...
final class ProjectServiceTests: XCTestCase {
  ...
  func testCreateProject_Minimal() throws {
    ...
    XCTAssertTrue(
      FileManager.default.fileExists(atPath: projectURL.path, isDirectory: &isDirectory))
  ...
  func testCreateProject_AlreadyExists() throws {
    ...
    XCTAssertThrowsError(
      try projectService.createProject(at: projectURL, title: "Second", author: "Author")
    ) { error in
  ...
  func testOpenProject_AutoCreatesManifest() throws {
    ...
    let manifestURL = projectURL.appendingPathComponent("PROJECT.md")
    XCTAssertFalse(
      FileManager.default.fileExists(atPath: manifestURL.path), "PROJECT.md should not exist yet")
    ...
    XCTAssertTrue(
      ...
      "PROJECT.md should have been created")
  ...
  func testDiscoverFiles_SkipsHiddenAndCache() async throws {
    ...
    let project = try projectService.createProject(
      at: projectURL, title: "Filter", author: "Author")
  ...
  func testDiscoverFiles_AllFiles() async throws {
    ...
    let project = try projectService.createProject(
      at: projectURL, title: "AllFiles", author: "Author")
  ...
  func testDiscoverFiles_RemovesDeletedFiles() async throws {
    ...
    let project = try projectService.createProject(
      at: projectURL, title: "Deleted", author: "Author")
  ...
  func testGetSecureURL_FileNotFound() async throws {
    ...
    let project = try projectService.createProject(
      at: projectURL, title: "NotFound", author: "Author")
  ...
  func testGetSecureURL_NestedFile() async throws {
    ...
    let project = try projectService.createProject(
      at: projectURL, title: "Nested", author: "Author")
  ...
  func testCreateFileBookmark_Success() async throws {
    ...
    let project = try projectService.createProject(
      at: projectURL, title: "Bookmark", author: "Author")
  ...
  func testRefreshBookmark_Success() async throws {
    ...
    let project = try projectService.createProject(
      at: projectURL, title: "Refresh", author: "Author")
  ...
  func testProjectErrorDescriptions() {
    ...
    let projectManifestInvalidError = ProjectService.ProjectError.projectManifestInvalid(
      "Invalid YAML")
