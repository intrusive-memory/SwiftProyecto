...
final class ProjectModelTests: XCTestCase {
  ...
  func testSortedFileReferences() {
    ...
    let file1 = ProjectFileReference(
      relativePath: "z-file.fountain", filename: "z-file.fountain", fileExtension: "fountain")
    let file2 = ProjectFileReference(
      relativePath: "a-file.fountain", filename: "a-file.fountain", fileExtension: "fountain")
    let file3 = ProjectFileReference(
      relativePath: "m-file.fountain", filename: "m-file.fountain", fileExtension: "fountain")
  ...
  func testFileReferenceAtPath() {
    ...
    let file1 = ProjectFileReference(
      relativePath: "file1.fountain", filename: "file1.fountain", fileExtension: "fountain")
    let file2 = ProjectFileReference(
      relativePath: "season-01/file2.fountain", filename: "file2.fountain",
      fileExtension: "fountain")
  ...
  func testCascadeDelete() throws {
    ...
    let fileRef2 = ProjectFileReference(
      relativePath: "file2.fountain", filename: "file2.fountain", fileExtension: "fountain")
    ...
    XCTAssertTrue(
      allFileRefs.isEmpty, "File references should be cascade deleted when project is deleted")
  }
  ...
  func testFileTree_SortedChildren() {
    ...
    let fileZ = ProjectFileReference(
      relativePath: "z-file.fountain", filename: "z-file.fountain", fileExtension: "fountain")
    let fileA = ProjectFileReference(
      relativePath: "a-file.fountain", filename: "a-file.fountain", fileExtension: "fountain")
    let dirB = ProjectFileReference(
      relativePath: "b-folder/script.fountain", filename: "script.fountain",
      fileExtension: "fountain")
  ...
  func testFileTree_AllFilesAndDirectories() {
    ...
    let file1 = ProjectFileReference(
      relativePath: "root.fountain", filename: "root.fountain", fileExtension: "fountain")
    let file2 = ProjectFileReference(
      relativePath: "dir1/nested.fountain", filename: "nested.fountain", fileExtension: "fountain")
    let file3 = ProjectFileReference(
      relativePath: "dir1/subdir/deep.fountain", filename: "deep.fountain",
      fileExtension: "fountain")
  ...
  func testSortedFileReferences_NestedPaths() {
    ...
    let file1 = ProjectFileReference(
      relativePath: "z/a.fountain", filename: "a.fountain", fileExtension: "fountain")
    let file2 = ProjectFileReference(
      relativePath: "a/z.fountain", filename: "z.fountain", fileExtension: "fountain")
    let file3 = ProjectFileReference(
      relativePath: "m.fountain", filename: "m.fountain", fileExtension: "fountain")
