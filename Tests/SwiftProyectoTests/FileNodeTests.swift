...
final class FileNodeTests: XCTestCase {
  ...
  func testBuildTree_MultipleRootFiles() {
    let files = [
      ...
      ProjectFileReference(
        relativePath: "LICENSE.txt", filename: "LICENSE.txt", fileExtension: "txt"),
      ProjectFileReference(
        relativePath: "script.fountain", filename: "script.fountain", fileExtension: "fountain"),
    ]
  ...
  func testBuildTree_SingleDirectory() {
    let files = [
      ProjectFileReference(
        relativePath: "Season 1/ep1.fountain", filename: "ep1.fountain", fileExtension: "fountain"),
      ProjectFileReference(
        relativePath: "Season 1/ep2.fountain", filename: "ep2.fountain", fileExtension: "fountain"),
    ]
  ...
  func testBuildTree_NestedDirectories() {
    let files = [
      ProjectFileReference(
        relativePath: "Season 1/Episode 1/script.fountain", filename: "script.fountain",
        fileExtension: "fountain"),
      ProjectFileReference(
        relativePath: "Season 1/Episode 2/script.fountain", filename: "script.fountain",
        fileExtension: "fountain"),
      ProjectFileReference(
        relativePath: "Season 2/Episode 1/script.fountain", filename: "script.fountain",
        fileExtension: "fountain"),
    ]
  ...
  func testBuildTree_MixedStructure() {
    let files = [
      ProjectFileReference(relativePath: "README.md", filename: "README.md", fileExtension: "md"),
      ProjectFileReference(
        relativePath: "src/main.fountain", filename: "main.fountain", fileExtension: "fountain"),
      ProjectFileReference(
        relativePath: "src/scene2.fountain", filename: "scene2.fountain", fileExtension: "fountain"),
      ProjectFileReference(
        relativePath: "tests/test1.txt", filename: "test1.txt", fileExtension: "txt"),
    ]
  ...
  func testFindNode_FindsRootFile() {
    let fileRef = ProjectFileReference(
      relativePath: "README.md", filename: "README.md", fileExtension: "md")
    let tree = FileNode.buildTree(from: [fileRef])
  ...
  func testSortedChildren_DirectoriesFirst() {
    let files = [
      ProjectFileReference(
        relativePath: "z-file.txt", filename: "z-file.txt", fileExtension: "txt"),
      ProjectFileReference(
        relativePath: "a-dir/file.txt", filename: "file.txt", fileExtension: "txt"),
      ProjectFileReference(
        relativePath: "m-file.txt", filename: "m-file.txt", fileExtension: "txt"),
    ]
    let tree = FileNode.buildTree(from: files)
  ...
  func testSortedChildren_AlphabeticalWithinType() {
    let files = [
      ...
      ProjectFileReference(
        relativePath: "middle.txt", filename: "middle.txt", fileExtension: "txt"),
    ]
    let tree = FileNode.buildTree(from: files)
  ...
  func testProjectModel_FileTree_WithFiles() {
    ...
    let file2 = ProjectFileReference(
      relativePath: "Season 1/ep1.fountain", filename: "ep1.fountain", fileExtension: "fountain")
    let file3 = ProjectFileReference(
      relativePath: "Season 1/ep2.fountain", filename: "ep2.fountain", fileExtension: "fountain")
  ...
  func testProjectModel_FileTree_ComplexStructure() {
    ...
    let files = [
      ...
      ProjectFileReference(
        ...
        fileExtension: "fountain"),
      ProjectFileReference(
        relativePath: "Season 1/Episode 1/notes.md", filename: "notes.md", fileExtension: "md"),
      ProjectFileReference(
        relativePath: "Season 1/Episode 2/script.fountain", filename: "script.fountain",
        fileExtension: "fountain"),
      ProjectFileReference(
        ...
        fileExtension: "fountain"),
      ProjectFileReference(
        relativePath: "assets/logo.png", filename: "logo.png", fileExtension: "png"),
    ]
