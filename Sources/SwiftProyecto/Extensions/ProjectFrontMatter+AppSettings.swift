...
extension ProjectFrontMatter {
  ...
  /// }
  /// ```
  public func settings<T: AppFrontMatterSettings>(for type: T.Type) throws -> T? {
  ...
  /// ```
  public mutating func setSettings<T: AppFrontMatterSettings>(_ settings: T) throws {
  ...
  /// }
  /// ```
  public func hasSettings<T: AppFrontMatterSettings>(for type: T.Type) -> Bool {
