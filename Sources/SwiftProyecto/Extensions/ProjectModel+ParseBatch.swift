...
extension ProjectModel {
  ...
  public func parseBatchConfig(with args: ParseBatchArguments? = nil) throws -> ParseBatchConfig {
    ...
    // Discover files
    config.discoveredFiles = try discoverFiles(
      in: config.episodesDirURL, patterns: config.filePatterns)
...
extension ParseBatchConfig {
  ...
  public static func from(projectPath: String, args: ParseBatchArguments? = nil) throws
    -> ParseBatchConfig
  {
