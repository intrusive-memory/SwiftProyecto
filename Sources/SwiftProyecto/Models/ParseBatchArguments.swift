...
/// Command-line arguments for batch audio generation.
/// These represent the raw arguments passed to the CLI for processing multiple files.
public struct ParseBatchArguments: Sendable, Codable, Equatable {
